...
const expertiseList = [
  ...
  },
  {
    ...
    text: "Заливаємо цільовий трафік та керуємо рекламними кампаніями. Наш відділ продажів обробляє заявки за скриптами та дотискає лідів до оплати. Ми контролюємо кожен показник (ROI, ROMI) та системно масштабуємо прибуток.",
