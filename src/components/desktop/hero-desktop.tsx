      ...
      <div className="container mx-auto px-6 h-full flex flex-col justify-center relative z-20">
        <div className="flex flex-row items-center gap-12">
          <div className="max-w-4xl space-y-6">
            ...
            <div className="hero-elem w-full flex flex-col items-start pt-4">
              <button
                onClick={() => openModal("hero_cta")}
                className="px-10 py-5 rounded-full bg-white text-black font-bold text-lg hover:bg-neutral-200 hover:scale-[1.02] active:scale-95 transition-all duration-300 shadow-[0_0_40px_rgba(255,255,255,0.3)] cursor-pointer"
              >
